 ...
 * song details.
 */
public class MainActivity extends AppCompatActivity implements SongDetailFragment.OnFragmentInteractionListener {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mTwoPane)
                    {
                        SongDetailFragment fragment = SongDetailFragment.newInstance(holder.getAdapterPosition());
